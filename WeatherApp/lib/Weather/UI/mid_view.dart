            ...
            children: <Widget>[
              Padding(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("${forecast.speed.toStringAsFixed(1)} mi/h",style:const TextStyle(color: Colors.white)),
                    const Icon(
                      FontAwesomeIcons.wind,
                      size: 20,
              ...
              Padding(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("${forecast.humidity.toStringAsFixed(0)} %",style:const TextStyle(color: Colors.white)),
                    const Icon(
                      FontAwesomeIcons.solidGrinBeamSweat,
                      size: 20,
                      color: Colors.white60,
              ...
              Padding(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("${forecast.temp.max.toStringAsFixed(0)}°F ",style:const TextStyle(color: Colors.white),),
                    const Icon(
                      FontAwesomeIcons.temperatureHigh,
                      size: 20,
                      color: Colors.white60,
